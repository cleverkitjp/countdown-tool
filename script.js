...
window.addEventListener("DOMContentLoaded", () => {
  ...
  // ページ初期化：URLパラメータから値を復元
  initFromUrlParams();
  // URLの theme に基づいてテーマ適用（なければ cool）
...
// 共通フッター読み込み（これは DOMContentLoaded 前でも問題ない）
